...
class EditGroup extends React.Component {
  ...
  state = {
    ...
    myGroupsTab: true,
    suggestedTab: false,
    members: this.props.navigation.getParam("group").members,
    memberIds: this.props.navigation.getParam("group").memberIds,
    groupTitle: this.props.navigation.getParam("group").groupTitle,
    groupDescription: this.props.navigation.getParam("group").groupDescription,
    groupType: this.props.navigation.getParam("group").groupType,
    groupCreator: {},
    searchWord: "",
    foundUser: "",
    profilePic: "",
    groupPhoto: this.props.navigation.getParam("group").groupPhoto,
    found: false,
      ...
      <Block>
        ...
        <Block center style={{ marginTop: 45 }}>
          ...
          <Block row style={{ zIndex: 2, alignSelf: "flex-start" }}>
            ...
            {this.renderAddGroupPhotoButton()}
          </Block>
          {/* <ScrollView> */}
          <Block center>
            {this.renderFields()}
